...
public class AdminDodajZwolnienie extends AppCompatActivity {
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            ...
                            String query = "INSERT INTO `zwolnienia_lekarskie` (`id_zwolnienia`, `id_pracownik`, " +
                            ...
                            if (nazwa.equals("''") || liczba_dni.equals("''")) {
                                ...
                                String exit = new DatabaseSelect(AdminDodajZwolnienie.this).
                                        execute("insert", username, password, query).get();
                                Toast toast = Toast.makeText(getApplicationContext(),
                                        "Pomyślnie dodano zwolnienie!", Toast.LENGTH_LONG);
                                toast.show();
                                finish();
                            }
