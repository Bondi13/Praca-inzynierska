...
public class AdminEdytujUrlop extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_wyloguj_usun:
                ...
                return true;
            case R.id.menu_usun:
                String query = "DELETE FROM urlopy WHERE id_urlop LIKE " + id;
                ...
                try {
                    String exit = new DatabaseSelect(AdminEdytujUrlop.this).
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            String query = "SELECT p.id_pracownik, nazwisko, imie FROM pracownik p " +
                    "JOIN urlopy u ON p.id_pracownik = u.id_pracownik WHERE id_urlop LIKE '" + id + "'";
            ...
            query = "SELECT * FROM urlopy WHERE id_urlop LIKE '" + id + "'";
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            ...
                            query = "select sum(liczba_dni) from urlopy " +
                                    "where id_pracownik like '" + id + "' and rok like '" + rok + "'";
                            exit = new DatabaseSelect(AdminEdytujUrlop.this).
                            ...
                            if (Integer.parseInt(dni_dotychczas) + Integer.parseInt(liczba_dni) > 20) {
                                ...
                                exit = new DatabaseSelect(AdminEdytujUrlop.this).
                                        execute("insert", username, password, query).get();
                                Toast toast = Toast.makeText(getApplicationContext(),
                                        "Pomyślnie zaktualizowano urlop!", Toast.LENGTH_LONG);
                                toast.show();
                                finish();
                            }
