...
public class AdminWypiszZwolnienia extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_dodaj:
                intent = new Intent(getApplicationContext(), AdminDodajZwolnienie.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_zwolnienia);
        ...
        String query = "SELECT id_zwolnienia, nazwisko, imie, nazwa, miesiac, rok, liczba_dni " +
                "FROM zwolnienia_lekarskie z JOIN pracownik p ON p.id_pracownik = z.id_pracownik";
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String id_zwolnienie = (String) viewById.getText();

                Intent intent = new Intent(AdminWypiszZwolnienia.this, AdminEdytujZwolnienie.class);
                intent.putExtra("username", username);
                intent.putExtra("password", password);
                intent.putExtra("id", id_zwolnienie);
                startActivity(intent);
            }
        });
    }
